...
geometry_points.vertices = coords.map(coord => new THREE.Vector3(coord[0], coord[1], coord[2]));
const material_points = new THREE.PointsMaterial({size: 0.2, color: 0xffffff});
const mesh_points = new THREE.Points(geometry_points, material_points);
